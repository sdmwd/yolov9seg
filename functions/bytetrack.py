...
# track_thresh and match_thresh are set to ensure robust tracking.
# track_buffer is used to manage the duration a track is kept after it was last seen, which helps in maintaining continuity.
